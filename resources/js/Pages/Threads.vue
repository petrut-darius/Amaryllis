        ...
        <div class="space-y-16 md:space-y-32">
            ...
            <div class="max-w-4xl mx-auto text-center space-y-12">
                <div class="space-y-6">
                    ...
                    <h1 class="text-5xl md:text-8xl font-serif text-brand-charcoal animate-reveal">Threads</h1>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-16 gap-y-32 animate-fade-in-up delay-700">
                ...
                >
                    ...
                    <div class="flex justify-between items-baseline pt-4 px-1">
                        <div class="space-y-2">
                            <h3 class="text-2xl font-serif text-brand-charcoal group-hover:text-brand-gold transition-colors duration-700 italic">{{ thread.name }}</h3>
            ...
            <!-- Empty State -->
            <div v-if="!threads.data || threads.data.length === 0" class="text-center py-32 border-t border-brand-charcoal">
