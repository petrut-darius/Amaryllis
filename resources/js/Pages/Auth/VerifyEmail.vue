...
<template>
    <AuthLayout>
        ...
        >
            Îți mulțumim pentru înregistrare! Înainte de a începe, ai putea să
            îți verifici adresa de email dând click pe link-ul pe care tocmai ți
            l-am trimis? Dacă nu ai primit emailul, îți vom trimite cu plăcere
            un altul.
        </div>
        ...
        >
            Un nou link de verificare a fost trimis către adresa de email
            furnizată în timpul înregistrării.
        </div>
