        ...
        <div class="space-y-16 md:space-y-32">
            ...
            <div class="max-w-4xl mx-auto text-center space-y-12">
                <div class="space-y-6">
                    ...
                    <h1 class="text-5xl md:text-8xl font-serif text-brand-charcoal animate-reveal">Funeral Arrangements</h1>
                </div>
            ...
            <!-- Empty State -->
            <div v-if="!funeralArrangements.data || funeralArrangements.data.length === 0" class="text-center py-32 border-t border-brand-charcoal">
