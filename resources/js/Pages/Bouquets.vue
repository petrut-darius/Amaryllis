...
const structuredData = computed(() => {
    return JSON.stringify({
        ...
        description:
            'Colecția noastră de buchete de flori artizanale create în Târgu Mureș.',
...
<template>
    <Head>
        ...
        <meta
            name="description"
            content="Descoperă colecția noastră de buchete de flori artizanale. Fiecare buchet este o compoziție unică din flori proaspete de sezon, creată cu pasiune în atelierul nostru."
        />
        <link rel="canonical" :href="route('bouquets')" />

        <meta
            property="og:title"
            content="Buchete de Flori | Amaryllis Târgu Mureș"
        />
        <meta
            property="og:description"
            content="Descoperă colecția noastră de buchete de flori artizanale. Fiecare buchet este o compoziție unică din flori proaspete de sezon."
        />
    ...
    <GuestLayout>
        <div class="space-y-8 px-4 md:space-y-12 md:px-0">
            ...
            <!-- Empty State -->
            <div
                v-if="!bouquets.data || bouquets.data.length === 0"
