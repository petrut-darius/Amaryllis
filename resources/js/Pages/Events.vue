...
<template>
    ...
    <GuestLayout>
        <div class="space-y-8 md:space-y-16 px-4 md:px-0">
            ...
            <!-- Categories Grid -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-4 lg:gap-12">
                ...
                >
                    ...
                    <div class="absolute inset-0 flex flex-col items-center justify-center p-6 md:p-12 text-center text-white">
                        <div class="space-y-4 md:space-y-6">
                            <h3 class="text-xl md:text-3xl font-serif tracking-[0.1em]">{{ category.name }}</h3>
