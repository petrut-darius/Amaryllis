...
use App\Filament\Resources\Bouquets\Pages\ViewBouquet;
use App\Filament\Resources\Bouquets\Schemas\BouquetForm;
use App\Filament\Resources\Bouquets\Schemas\BouquetInfolist;
...
class BouquetResource extends Resource
{
    ...
    {
        return BouquetInfolist::configure($schema);
    }
