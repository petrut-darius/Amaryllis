...
use App\Filament\Resources\Weddings\Pages\ViewWedding;
use App\Filament\Resources\Weddings\Schemas\WeddingForm;
use App\Filament\Resources\Weddings\Schemas\WeddingInfolist;
...
class WeddingResource extends Resource
{
    ...
    {
        return WeddingInfolist::configure($schema);
    }
